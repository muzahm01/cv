...
\begin{description}
    ...
    \item[Test Automation] Pytest, Appium
    \item[Mobile Testing] Android, iOS
    \item[CI/CD] GitHub Actions, CI infrastructure
    \item[Testing Types] Integration, Smoke, Acceptance, E2E, Regression, Exploratory
    \item[Test Planning] Test plans, Test cases, Test scripts, Frameworks
    \item[Collaboration] Cross-functional teams, Design discussions, Pair programming
    \item[Issue Tracking] Defect reporting, Tracking, Regression automation
\end{description}
...
\noindent\textbf{ŌURA} \hfill \textbf{July 2021 – Present} \\
...
\noindent\textbf{Pelion} \hfill \textbf{April 2021 – July 2021} \\
...
\noindent\textbf{Pelion} \hfill \textbf{November 2020 – April 2021} \\
\textit{Senior Test Development Engineer} \\
\begin{itemize}
...
\noindent\textbf{ARM} \hfill \textbf{April 2017 – November 2020} \\
...
\noindent\textbf{ARM} \hfill \textbf{March 2016 – April 2017} \\
...
\noindent\textbf{i2c Inc} \hfill \textbf{April 2009 – August 2012} \\
